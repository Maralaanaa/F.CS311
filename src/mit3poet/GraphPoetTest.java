...
public class GraphPoetTest {
    ...
    public void testMultipleLines() throws IOException {
        GraphPoet poet = new GraphPoet(new File("C:\\Users\\Ben\\eclipse-workspace\\2B\\F.CS311\\src\\poet\\Where-no-man-has-gone-before"));
    ...
    public void testOneBridge() throws IOException {
        GraphPoet poet = new GraphPoet(new File("C:\\Users\\Ben\\eclipse-workspace\\2B\\F.CS311\\src\\poet\\one-bridge"));
    ...
    public void testMultipleBridgesSameWeightCaseInsensitive() throws IOException {
        GraphPoet poet = new GraphPoet(new File("C:\\Users\\Ben\\eclipse-workspace\\2B\\F.CS311\\src\\poet\\multiple-bridges-same-weight-case-insensitive"));
    ...
    public void testMultipleBridgesDifferentWeight() throws IOException {
        GraphPoet poet = new GraphPoet(new File("C:\\Users\\Ben\\eclipse-workspace\\2B\\F.CS311\\src\\poet\\multiple-bridges-different-weight"));
        String poem = poet.poem("multiple bridges");
