...
public class main {
	public static void main(String[] args) {
		...
		case 1:
		if (q.isEmpty()) {
		System.out.println("Daraalald nemegdsen utga
		alga.");
		} else {
		System.out.println("Daraalald utga hadgalaastai
		baina");
		}
		break;
		case 2:
		...
		System.out.println("Daraalald oruulsan utguud amjilttai
		nemegdlee.");
		break;
		case 4:
		q.queueDisplay();
		...
		q.queueDisplay();
		System.out.println("Daraallaas utguud amjilttai
		hasagdlaa");
		break;
		case 6:
		q.queueFront();
		System.out.println("\nDaraalliin hamgiin urd taliin utgiig
		haruullaa.");
		break;
		default:
